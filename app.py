...
def update_graph(selected_track, min_speed, max_speed, aggressiveness, smoothing_factor, acceleration_modifier,
    ...
    fig.add_trace(go.Scatter(x=x_right_filtered, y=y_right_filtered, mode='lines', line=dict(color='#E5ECF6', width=2), showlegend=False))
    fig.add_trace(go.Scatter(x=x_left_filtered, y=y_left_filtered, mode='lines', line=dict(color='#E5ECF6', width=2), showlegend=False))
